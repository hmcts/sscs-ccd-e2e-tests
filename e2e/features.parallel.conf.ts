...
const retries: number = Math.max(serviceConfig.get('protractor.testRetries'), 2);
...
const featuresPath = path.resolve(process.cwd(), 'e2e/features/search-filter.feature');
